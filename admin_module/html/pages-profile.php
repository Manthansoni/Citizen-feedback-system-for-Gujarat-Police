<?php 
    ...
    if(isset($_SESSION['headID'])){
        ...
        $qry = "SELECT * FROM loginofficer where headID='$headid'";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-xlg-4 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="../assets/images/users/1.jpg" class="rounded-circle"
                                        width="150" height="150" />
                                    <h4 class="card-title m-t-10"><?php echo $f['name']; ?></h4>
                                    <h6 class="card-subtitle"><?php echo $f['post']; ?></h6>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6><?php echo $f['emailid']; ?></h6> <small
                                    class="text-muted p-t-30 db">Phone</small>
                                <h6><?php echo $f['contact']; ?></h6> <small class="text-muted p-t-30 db">Appointed for</small>
                                <h6><?php echo $f['city']; ?></h6>
                                <div class="map-box">
                                <iframe src="<?php echo $f['map']; ?>"
