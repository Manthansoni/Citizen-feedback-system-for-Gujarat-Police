        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        <h1 class="mb-0 fw-bold">Complaints</h1>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-striped" id="ct">
                                    ...
                                    <tbody>
                                            <?php
                                                $qry2 = "SELECT * FROM complaint as c,policestation as p where c.psID=p.psID";
					                            $q2 = mysqli_query($con, $qry2);
                                                $i=1;
                    					        while ($fetch = mysqli_fetch_array($q2)) {
                                                    $cid=$fetch['cID'];
                                                    $qry3 = "UPDATE `complaint` SET `status`=1 where `cID`='$cid'";
					                                $q3 = mysqli_query($con, $qry3);
                                                        echo "<tr>";
                                                        echo "<td>" .$i. "</td>";
					                        	        echo "<td>" . $fetch['name'] .  "</td>";
                                                        echo "<td>" . $fetch['firNo'] .  "</td>";
                                                        echo "<td>" . $fetch['date'] .  "</td>";
                                                        echo "<td>" . $fetch['time'] .  "</td>";
                                                        echo "<td>" . $fetch['complainDetails'] . "</td>";
                                                        $i++;
                                                        echo "</tr>";
				                            }
                                            ?>
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#ct')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("Complaint-details.pdf");
                }
            });
        });
    </script> -->
